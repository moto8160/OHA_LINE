      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-[#06C755] hover:bg-[#05B04D] text-white font-semibold py-4 px-6 rounded-lg shadow-md transition-colors flex items-center justify-center gap-3"
          >
            <svg
              className="w-6 h-6"
              viewBox="0 0 24 24"
